                            ...
                            foreach ($_SESSION['cart'] as $key => $value) {
                                ...
                                echo "<tr>
                                            ...
                                            <td>$value[Price]<input type='hidden' class='item_price' value='$value[Price]'</td>
                                                ...
                                                <form action='manage_cart.php' method='post'>
                                                <td>
                                                <button name='Remove_Item' class='btn btn-sm btn-danger'>REMOVE     <i class='bi bi-trash3-fill'></i></button>
                                                <input type='hidden' name='Item_Name' value='$value[Item_Name]'/>
                                                </td>
                                                </form>
                                                </tr>";
                    ...
                    ?>
                        <form action="purchase.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" required name="Phone_No" class="form-control">
                            </div>
                            <br>
